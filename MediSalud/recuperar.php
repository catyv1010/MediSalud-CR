            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-9">
                    <div class="form-contact" style="background:white; padding:50px 40px; border-radius:8px; box-shadow:0 4px 20px rgba(0,0,0,0.08);">
                        ...
                        <form action="control/recuperar_procesar.php" method="POST" id="form-recuperar">
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="form-group mt-4 text-center">
                                <button type="submit" style="width:100%; background:#244cb6; color:#ffffff; border:none; padding:14px 20px; border-radius:6px; font-size:16px; font-weight:bold; cursor:pointer; transition:background 0.2s;" onmouseover="this.style.background='#1a3a8c'" onmouseout="this.style.background='#244cb6'">Enviar enlace de recuperación</button>
                            </div>
                            <div class="text-center mt-4">
                                <p>
                                    <a href="login.php" style="color:#244cb6;">Volver al inicio de sesión</a>
                                </p>
