                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-10">
                            <div class="hero__caption">
                                ...
                                <a href="registro.php" data-animation="fadeInLeft" data-delay="1.0s" class="btn hero-btn">Crear cuenta</a>
                                <a href="login.php" data-animation="fadeInLeft" data-delay="1.2s" class="btn hero-btn" style="margin-left:10px;">Iniciar sesión</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-9 col-md-10 text-center" style="color:white;">
                    ...
                    <a href="registro.php" class="btn hero-btn">Registrarse</a>
                </div>
            </div>
        </div>
    </div>
